...
export class ClassRecordComponent {
  records: Record[] = [
    { id: 20225050, name: 'Zchiavoni Tad-awan', type: 'Homework', age: 20, grade: 'A', address: 'Baguio' },
    { id: 20225051, name: 'John Doe', type: 'Assignment', age: 21, grade: 'B', address: 'Baguio' }
  ];
